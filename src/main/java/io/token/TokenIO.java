...
public final class TokenIO {
     ...
     * @return nothing
     */
    public void notifyAddKey(String alias, byte[] publicKey, String name) {
        async.notifyAddKey(alias, publicKey, name)
                .map(empty -> null)
                .toBlocking()
                .single();
    }
    ...
    public void notifyLinkAccountsAndAddKey(
            ...
            byte[] publicKey,
            String name) {
        async.notifyLinkAccountsAndAddKey(alias, bankId, accountLinkPayload, publicKey, name)
                .map(empty -> null)
                .toBlocking()
                .single();
    }
