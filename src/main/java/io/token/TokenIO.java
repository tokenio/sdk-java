...
public final class TokenIO {
     ...
     */
    public void notifyLinkAccounts(String username, String bankId, String accountLinkPayload) {
        async.notifyLinkAccounts(username, bankId, accountLinkPayload)
                .map(empty -> null)
                .toBlocking()
                .single();
    }
    ...
    public void notifyLinkAccountsAndAddKey(
            ...
            byte[] publicKey,
            String name) {
        async.notifyLinkAccountsAndAddKey(username, bankId, accountLinkPayload, publicKey, name)
                .map(empty -> null)
                .toBlocking()
                .single();
    }
